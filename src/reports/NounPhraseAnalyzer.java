...
public final class NounPhraseAnalyzer {
    ...
    public List<EventNounPhraseReport> analyze(
        ...
        Map<Integer, List<EventCommentReport>> grouped =
                comments.stream()
        ...
        List<EventNounPhraseReport> reports =
                new ArrayList<>();


        for (List<EventCommentReport> eventComments :
                grouped.values()) {


            EventCommentReport first =
                    eventComments.get(0);
            ...
            for (EventCommentReport comment :
                    eventComments) {
    ...
    private List<String> extractNounPhrases(
        ...
        String[] tokens =
                SimpleTokenizer.INSTANCE.tokenize(
                        text
                );
